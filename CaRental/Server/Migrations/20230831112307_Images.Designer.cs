...
namespace CaRental.Server.Migrations
{
    ...
    [Migration("20230831112307_Images")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CaRental.Shared.Address", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CaRental.Shared.CartItem", b =>
                {
                    b.Property<int>("UserId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("UserId", "CarId", "EditionId");
            ...
            modelBuilder.Entity("CaRental.Shared.FileImage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CaRental.Shared.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CaRental.Shared.OrderItem", b =>
                {
                    ...
                    b.HasKey("OrderId", "CarId", "EditionId");
            ...
            modelBuilder.Entity("CaRental.Shared.Address", b =>
                {
                    b.HasOne("CaRental.Shared.User", null)
                        .WithOne("Address")
                        .HasForeignKey("CaRental.Shared.Address", "UserId")
            ...
            modelBuilder.Entity("CaRental.Shared.OrderItem", b =>
                {
                    ...
                    b.HasOne("CaRental.Shared.Order", "Order")
                        .WithMany("OrderItems")
